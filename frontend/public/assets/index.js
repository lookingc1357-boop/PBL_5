...
async function createParserModule(moduleArg = {}) {
  var moduleRtn;
...
var _free_tree = Module["_free_tree"] = makeInvalidEarlyAccess("_free_tree");

var _build_tree = Module["_build_tree"] = makeInvalidEarlyAccess("_build_tree");

var _update_tree = Module["_update_tree"] = makeInvalidEarlyAccess("_update_tree");

var _get_all_func = Module["_get_all_func"] = makeInvalidEarlyAccess("_get_all_func");

var _malloc = Module["_malloc"] = makeInvalidEarlyAccess("_malloc");

var _free = Module["_free"] = makeInvalidEarlyAccess("_free");

var _get_current_func_editing = Module["_get_current_func_editing"] = makeInvalidEarlyAccess("_get_current_func_editing");
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports["free_tree"] != "undefined", "missing Wasm export: free_tree");
  assert(typeof wasmExports["build_tree"] != "undefined", "missing Wasm export: build_tree");
  assert(typeof wasmExports["update_tree"] != "undefined", "missing Wasm export: update_tree");
  assert(typeof wasmExports["get_all_func"] != "undefined", "missing Wasm export: get_all_func");
  assert(typeof wasmExports["malloc"] != "undefined", "missing Wasm export: malloc");
  assert(typeof wasmExports["free"] != "undefined", "missing Wasm export: free");
  assert(typeof wasmExports["get_current_func_editing"] != "undefined", "missing Wasm export: get_current_func_editing");
  ...
  _free_tree = Module["_free_tree"] = createExportWrapper("free_tree", 1);
  _build_tree = Module["_build_tree"] = createExportWrapper("build_tree", 1);
  _update_tree = Module["_update_tree"] = createExportWrapper("update_tree", 11);
  _get_all_func = Module["_get_all_func"] = createExportWrapper("get_all_func", 2);
  _malloc = Module["_malloc"] = createExportWrapper("malloc", 1);
  _free = Module["_free"] = createExportWrapper("free", 1);
  _get_current_func_editing = Module["_get_current_func_editing"] = createExportWrapper("get_current_func_editing", 4);
...
if (typeof window !== 'undefined') {
  window.createParserModule = createParserModule;
}

// Export using a UMD style export, or ES6 exports if selected
export default createParserModule;
